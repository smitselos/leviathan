...
// Μπάνερ «Εγκαταστήστε την εφαρμογή» — εμφανίζεται μόνο όταν το ΛΕΒΙΑΘΑΝ
// δεν είναι ήδη εγκατεστημένο ως PWA.
// - Android / Chrome / Edge: κουμπί που ανοίγει το native παράθυρο εγκατάστασης
// - iOS / Safari: οδηγίες (Κοινοποίηση → Προσθήκη στην οθόνη Αφετηρίας)
// - Κλείσιμο με × → δεν ξαναεμφανίζεται για 7 ημέρες
